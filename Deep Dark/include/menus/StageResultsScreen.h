...
struct StageResultsScreen : public Menu<UI::StageUI::ResultsScreen::BTN_COUNT>{
	...
	void setup_results_screen(bool victorious, bool completedAllSets);

	inline void activate() { visible = clickable = true; }
	inline void deactivate() { visible = clickable = false; }
