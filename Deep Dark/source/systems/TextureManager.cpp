...
sf::Texture TextureManager::t_startBtn = createTexture(path(uiPath, "start_btn.png"));
...
// Armory Menu
sf::Texture TextureManager::t_enterStageSetBtn = createTexture(path(armoryPath, "enter_stage_set_btn.png"));
#pragma endregion
...
sf::Texture TextureManager::t_base1 = createTexture("sprites/bases/green_base.png");
sf::Texture TextureManager::t_base2 = createTexture("sprites/bases/toxic_base.png");
...
sf::Texture TextureManager::createTexture(const std::string& path) {
	sf::Texture tex;
